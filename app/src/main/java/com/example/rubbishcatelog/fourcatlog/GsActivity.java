...
public class GsActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragement_gs);
        TextView tv1=findViewById(R.id.news_item_content_text_view);
        String source=getResources().getString(R.string.gs);
...
//上一页
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.Gc:
                Intent intent4=new Intent(this, GcActivity.class);
